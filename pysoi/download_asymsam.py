...
def download_asymsam_monthly_data():
    """
    Download monthly Asymmetric and Symmetric SAM indices data.
    
    Returns:
        DataFrame: Monthly ASYMSAM data
    """
...
def download_asymsam_daily_data(levels=700):
    """
    Download daily Asymmetric and Symmetric SAM indices data for specified levels.
...
def download_asymsam_monthly(use_cache=False, file_path=None):
    """
    ...
    """
    return download_with_cache(use_cache, file_path, download_asymsam_monthly_data)


def download_asymsam_daily(levels=700, use_cache=False, file_path=None):
    """
    ...
    """
    def download_func():
        return download_asymsam_daily_data(levels)
    
    return download_with_cache(use_cache, file_path, download_func)
